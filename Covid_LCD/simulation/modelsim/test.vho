...
SIGNAL \covid_det_instance|out_ascii~0_combout\ : std_logic;
...
\Equal1~0\ : maxv_lcell
-- Equation(s):
-- \Equal1~0_combout\ = (!\Add0~130_combout\ & (\Add0~120_combout\ & (!\Add0~135_combout\ & \Add0~125_combout\)))
...
-- Equation(s):
-- div_clk(10) = DFFEAS((\Add0~20_combout\ & (((!\Equal0~7_combout\) # (!\Equal1~0_combout\)) # (!\Equal1~1_combout\))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
-- Equation(s):
-- div_clk(13) = DFFEAS((((\Add0~35_combout\))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
-- Equation(s):
-- div_clk(27) = DFFEAS((((\Add0~95_combout\))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
\Equal0~8\ : maxv_lcell
-- Equation(s):
-- \Equal0~8_combout\ = (\Add0~130_combout\ & (!\Add0~120_combout\ & (\Add0~135_combout\ & !\Add0~125_combout\)))
...
\Equal0~9\ : maxv_lcell
-- Equation(s):
-- \Equal0~9_combout\ = (!\Add0~140_combout\ & (\Add0~155_combout\ & (\Add0~150_combout\ & !\Add0~145_combout\)))
...
lcd_clk : maxv_lcell
-- Equation(s):
-- \lcd_clk~regout\ = DFFEAS((\lcd_clk~0_combout\) # ((\Equal0~7_combout\ & (\Equal0~8_combout\ & \Equal0~9_combout\))), GLOBAL(\clk~combout\), VCC, , , , , , )
...
-- Equation(s):
-- \lcd_instance|state.S1~regout\ = DFFEAS((!\rst~combout\ & (((\lcd_instance|LessThan0~0_combout\ & !\lcd_instance|state.S0~regout\)))), GLOBAL(\lcd_clk~regout\), VCC, , , , , , )
...
-- Equation(s):
-- \lcd_instance|state.S5~regout\ = DFFEAS(((\lcd_instance|state.S4~regout\ & (!\rst~combout\))), GLOBAL(\lcd_clk~regout\), VCC, , , , , , )
...
-- pragma translate_on
PORT MAP (
	datac => \lcd_instance|state.S4~regout\,
	datad => \lcd_instance|state.S7~regout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- pragma translate_on
PORT MAP (
	dataa => \lcd_instance|Selector8~1_combout\,
	datab => \lcd_instance|lcd_rs~regout\,
	datac => \lcd_instance|state.S9~regout\,
...
-- Equation(s):
-- \covid_det_instance|Equal0~0_combout\ = (!\inp~combout\(3) & (!\inp~combout\(2) & (\covid_det_instance|Equal3~0_combout\ & \inp~combout\(1))))
...
-- Equation(s):
-- \covid_det_instance|Equal4~0_combout\ = ((\covid_det_instance|Equal2~0_combout\ & (!\inp~combout\(1) & !\inp~combout\(4))))
...
-- Equation(s):
-- \covid_det_instance|Equal3~1_combout\ = (\inp~combout\(3) & (!\inp~combout\(2) & (\covid_det_instance|Equal3~0_combout\ & !\inp~combout\(1))))
...
-- Equation(s):
-- \covid_det_instance|Equal1~0_combout\ = (\inp~combout\(3) & (\inp~combout\(2) & (\covid_det_instance|Equal3~0_combout\ & \inp~combout\(1))))
...
-- Equation(s):
-- \covid_det_instance|Equal2~1_combout\ = ((\covid_det_instance|Equal2~0_combout\ & (\inp~combout\(1) & \inp~combout\(4))))
...
-- Equation(s):
-- \covid_det_instance|y_present.init~regout\ = DFFEAS((\covid_det_instance|Equal4~0_combout\ & (!\covid_det_instance|y_present.s4~regout\ & ((\covid_det_instance|Equal0~0_combout\) # (\covid_det_instance|y_present.init~regout\)))) # 
-- (!\covid_det_instance|Equal4~0_combout\ & ((\covid_det_instance|Equal0~0_combout\) # ((\covid_det_instance|y_present.init~regout\)))), GLOBAL(\clk_slow~combout\), !GLOBAL(\rst~combout\), , , , , , )
...
PORT MAP (
	...
	datab => \covid_det_instance|Equal0~0_combout\,
...
-- Equation(s):
-- \covid_det_instance|y_present.s1~regout\ = DFFEAS((\covid_det_instance|Equal1~0_combout\ & (\covid_det_instance|Equal0~0_combout\ & (!\covid_det_instance|y_present.init~regout\))) # (!\covid_det_instance|Equal1~0_combout\ & 
-- ((\covid_det_instance|y_present.s1~regout\) # ((\covid_det_instance|Equal0~0_combout\ & !\covid_det_instance|y_present.init~regout\)))), GLOBAL(\clk_slow~combout\), !GLOBAL(\rst~combout\), , , , , , )
...
PORT MAP (
	clk => \clk_slow~combout\,
	dataa => \covid_det_instance|Equal1~0_combout\,
	datab => \covid_det_instance|Equal2~1_combout\,
...
-- Equation(s):
-- \covid_det_instance|Selector3~0_combout\ = (\inp~combout\(4) & (\covid_det_instance|Equal2~0_combout\ & (\inp~combout\(1) & \covid_det_instance|y_present.s2~regout\)))
...
-- Equation(s):
-- \covid_det_instance|y_present.s4~regout\ = DFFEAS((\covid_det_instance|Equal4~0_combout\ & (\covid_det_instance|y_present.s3~regout\ & (\covid_det_instance|Equal3~1_combout\))) # (!\covid_det_instance|Equal4~0_combout\ & 
-- ((\covid_det_instance|y_present.s4~regout\) # ((\covid_det_instance|y_present.s3~regout\ & \covid_det_instance|Equal3~1_combout\)))), GLOBAL(\clk_slow~combout\), !GLOBAL(\rst~combout\), , , , , , )
...
\covid_det_instance|out_ascii~0\ : maxv_lcell
-- Equation(s):
-- \covid_det_instance|out_ascii~0_combout\ = ((\covid_det_instance|Equal0~0_combout\) # ((\covid_det_instance|y_present.s4~regout\)))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \covid_det_instance|out_ascii~0_combout\);
...
\Equal4~6\ : maxv_lcell
-- Equation(s):
-- \Equal4~6_combout\ = (!i(24) & (!i(25) & (!i(23) & !i(22))))
...
\Equal4~5\ : maxv_lcell
-- Equation(s):
-- \Equal4~5_combout\ = (!i(21) & (!i(20) & (!i(19) & !i(18))))
...
\Equal4~7\ : maxv_lcell
-- Equation(s):
-- \Equal4~7_combout\ = (!i(29) & (!i(27) & (!i(26) & !i(28))))
...
\Equal4~8\ : maxv_lcell
-- Equation(s):
-- \Equal4~8_combout\ = (!i(30) & (((!i(31) & \Equal4~7_combout\))))
...
\Equal4~1\ : maxv_lcell
-- Equation(s):
-- \Equal4~1_combout\ = (!i(9) & (!i(8) & (!i(6) & !i(7))))
...
\Equal4~3\ : maxv_lcell
-- Equation(s):
-- \Equal4~3_combout\ = (!i(15) & (!i(14) & (!i(17) & !i(16))))
...
\Equal2~0\ : maxv_lcell
-- Equation(s):
-- \Equal2~0_combout\ = (i(0)) # (((i(1)) # (\Equal4~9_combout\)))
...
\Equal5~0\ : maxv_lcell
-- Equation(s):
-- \Equal5~0_combout\ = (i(0) & (((i(1) & !\Equal4~9_combout\))))
...
-- Equation(s):
-- \write_data~0_combout\ = (\Equal5~0_combout\ & ((\covid_det_instance|y_present.s4~regout\) # ((\covid_det_instance|Equal3~1_combout\ & \covid_det_instance|y_present.s3~regout\))))
...
\write_data[0]\ : maxv_lcell
-- Equation(s):
-- write_data(0) = DFFEAS((\Equal2~0_combout\ & (((\write_data~2_combout\)))) # (!\Equal2~0_combout\ & ((\covid_det_instance|out_ascii~0_combout\) # ((\covid_det_instance|y_present.init~regout\)))), GLOBAL(\lcd_clk~regout\), VCC, , \put_char~0_combout\, , , 
...
PORT MAP (
	clk => \lcd_clk~regout\,
	dataa => \covid_det_instance|out_ascii~0_combout\,
...
-- Equation(s):
-- \lcd_instance|data_dis\(0) = DFFEAS((((write_data(0)))), GLOBAL(\lcd_clk~regout\), VCC, , \lcd_instance|state~28_combout\, , , , )
...
-- Equation(s):
-- \lcd_instance|Selector5~0_combout\ = (\lcd_instance|state.S2~regout\) # ((\lcd_instance|state.S1~regout\) # ((!\lcd_instance|state.S0~regout\ & \lcd_instance|LessThan0~0_combout\)))
...
-- Equation(s):
-- write_column(0) = DFFEAS((\lcd_instance|ack~regout\ & (((i(0) & !\Equal4~9_combout\)))), GLOBAL(\lcd_clk~regout\), VCC, , \put_char~0_combout\, , , , )
...
-- Equation(s):
-- \lcd_instance|lcd\(0) = DFFEAS((\lcd_instance|Selector7~0_combout\) # ((\lcd_instance|Selector7~1\) # ((\lcd_instance|data_dis\(0) & !\lcd_instance|Selector2~0\))), GLOBAL(\lcd_clk~regout\), VCC, , !\rst~combout\, , , , )
...
PORT MAP (
	...
	datac => \lcd_instance|Selector7~0_combout\,
...
-- Equation(s):
-- \Equal4~10_combout\ = (!i(0) & (((i(1) & !\Equal4~9_combout\))))
...
-- Equation(s):
-- \write_data~4_combout\ = (\Equal4~10_combout\ & ((\covid_det_instance|y_present.s4~regout\) # ((\covid_det_instance|y_present.s3~regout\) # (\covid_det_instance|Selector3~0_combout\))))
...
-- Equation(s):
-- \write_data~3_combout\ = (\lcd_instance|ack~regout\ & (!\Equal3~0_combout\ & (\write_data~1_combout\ & \Equal2~0_combout\)))
...
-- Equation(s):
-- \write_data~5_combout\ = (!\Equal2~0_combout\ & ((\covid_det_instance|y_present.s4~regout\) # ((\covid_det_instance|Equal0~0_combout\) # (\covid_det_instance|y_present.init~regout\))))
...
-- Equation(s):
-- \write_data~6_combout\ = (\lcd_instance|ack~regout\ & (((\write_data~5_combout\)))) # (!\lcd_instance|ack~regout\ & ((\rst~combout\) # ((write_data(1)))))
...
\write_data[1]\ : maxv_lcell
-- Equation(s):
-- write_data(1) = DFFEAS((\write_data~3_combout\) # ((\write_data~6_combout\) # ((\write_column[0]~2\ & \write_data~4_combout\))), GLOBAL(\lcd_clk~regout\), VCC, , , , , , )
...
PORT MAP (
	clk => \lcd_clk~regout\,
	dataa => \write_column[0]~2\,
	datab => \write_data~4_combout\,
...
-- Equation(s):
-- \lcd_instance|lcd\(1) = DFFEAS(((\lcd_instance|Selector6~0\) # ((\lcd_instance|data_dis\(1) & !\lcd_instance|Selector2~0\))), GLOBAL(\lcd_clk~regout\), VCC, , !\rst~combout\, , , , )
...
-- Equation(s):
-- \write_data~10_combout\ = ((\write_data~4_combout\) # ((!\Equal4~10_combout\ & \write_data~9_combout\)))
...
\write_data[2]\ : maxv_lcell
-- Equation(s):
-- write_data(2) = DFFEAS((\write_data~8_combout\) # ((\write_data~3_combout\) # ((\write_column[0]~2\ & \write_data~10_combout\))), GLOBAL(\lcd_clk~regout\), VCC, , , , , , )
...
-- Equation(s):
-- write_column(2) = DFFEAS(((!i(1) & (\lcd_instance|ack~regout\ & !\Equal4~9_combout\))), GLOBAL(\lcd_clk~regout\), VCC, , \put_char~0_combout\, , , , )
...
-- Equation(s):
-- \lcd_instance|Selector5~1\ = (\lcd_instance|lcd\(2) & (((C1_cmd_position[2] & !\lcd_instance|Selector8~0_combout\)) # (!\lcd_instance|lcd[4]~0_combout\))) # (!\lcd_instance|lcd\(2) & (((C1_cmd_position[2] & !\lcd_instance|Selector8~0_combout\))))
...
-- Equation(s):
-- \lcd_instance|lcd\(2) = DFFEAS((\lcd_instance|Selector5~2_combout\) # ((\lcd_instance|Selector5~1\) # ((!\lcd_instance|Selector2~0\ & \lcd_instance|data_dis\(2)))), GLOBAL(\lcd_clk~regout\), VCC, , !\rst~combout\, , , , )
...
PORT MAP (
	clk => \lcd_clk~regout\,
	dataa => \lcd_instance|Selector5~2_combout\,
	datab => \lcd_instance|Selector2~0\,
	datac => \lcd_instance|data_dis\(2),
...
-- Equation(s):
-- \lcd_instance|Selector4~1_combout\ = (!\lcd_instance|count_cmd\(0) & (!\lcd_instance|count_cmd\(2) & ((!\lcd_instance|state.S0~regout\) # (!\lcd_instance|Selector8~1_combout\))))
...
-- Equation(s):
-- \lcd_instance|lcd\(3) = DFFEAS((\lcd_instance|Selector4~1_combout\) # ((\lcd_instance|Selector4~0\) # ((\lcd_instance|data_dis\(3) & !\lcd_instance|Selector2~0\))), GLOBAL(\lcd_clk~regout\), VCC, , !\rst~combout\, , , , )
...
\write_data[4]\ : maxv_lcell
-- Equation(s):
-- write_data(4) = DFFEAS((\lcd_instance|ack~regout\ & (((\write_data~4_combout\)))) # (!\lcd_instance|ack~regout\ & ((write_data(4)) # ((\rst~combout\)))), GLOBAL(\lcd_clk~regout\), VCC, , , , , , )
...
-- Equation(s):
-- \lcd_instance|Selector2~1_combout\ = (!\lcd_instance|count_cmd\(2) & (!\lcd_instance|count_cmd\(1) & (!\lcd_instance|count_cmd\(0) & \lcd_instance|Selector2~0\)))
...
-- Equation(s):
-- \lcd_instance|lcd[4]~1_combout\ = (!\lcd_instance|state.S9~regout\ & (!\rst~combout\ & ((\lcd_instance|LessThan0~0_combout\) # (\lcd_instance|state.S0~regout\))))
...
-- Equation(s):
-- \lcd_instance|lcd\(4) = DFFEAS((\lcd_instance|Selector8~0_combout\ & ((\lcd_instance|Selector2~1_combout\) # ((\lcd_instance|data_dis\(4) & !\lcd_instance|Selector2~0\)))), GLOBAL(\lcd_clk~regout\), VCC, , \lcd_instance|lcd[4]~1_combout\, , , , )
...
PORT MAP (
	...
	datad => \lcd_instance|Selector2~1_combout\,
	aclr => GND,
...
-- Equation(s):
-- \write_data~14_combout\ = (!\Equal4~10_combout\ & (\Equal3~0_combout\ & ((\write_data~0_combout\) # (\write_data~9_combout\))))
...
-- Equation(s):
-- \write_data~15_combout\ = (\write_data~14_combout\) # ((\Equal3~0_combout\ & ((\write_data~4_combout\))) # (!\Equal3~0_combout\ & (\write_data~1_combout\)))
...
\write_data[6]\ : maxv_lcell
-- Equation(s):
-- write_data(6) = DFFEAS((\Equal2~0_combout\ & (((\write_data~15_combout\)))) # (!\Equal2~0_combout\ & ((\covid_det_instance|y_present.init~regout\) # ((\covid_det_instance|out_ascii~0_combout\)))), GLOBAL(\lcd_clk~regout\), VCC, , \put_char~0_combout\, , , 
-- !\lcd_instance|ack~regout\, )
...
PORT MAP (
	...
	datac => \covid_det_instance|out_ascii~0_combout\,
...
-- Equation(s):
-- \lcd_instance|lcd\(6) = DFFEAS((\lcd_instance|lcd\(6) & (((\lcd_instance|data_dis\(6) & !\lcd_instance|Selector2~0\)) # (!\lcd_instance|lcd[4]~0_combout\))) # (!\lcd_instance|lcd\(6) & (\lcd_instance|data_dis\(6) & (!\lcd_instance|Selector2~0\))), 
...
PORT MAP (
	clk => \lcd_clk~regout\,
	dataa => \lcd_instance|lcd\(6),
	datab => \lcd_instance|data_dis\(6),
	datac => \lcd_instance|Selector2~0\,
	datad => \lcd_instance|lcd[4]~0_combout\,
	aclr => GND,
	ena => \ALT_INV_rst~combout\,
	devclrn => ww_devclrn,
...
-- pragma translate_on
PORT MAP (
	datain => \covid_det_instance|y_present.s4~regout\,
	oe => VCC,
	padio => ww_detect);
END structure;
