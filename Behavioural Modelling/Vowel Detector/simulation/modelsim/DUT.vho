...
SIGNAL \add_instance|ALT_INV_Y~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\add_instance|ALT_INV_Y~0_combout\ <= NOT \add_instance|Y~0_combout\;
...
-- Equation(s):
-- \add_instance|Y~0_combout\ = (\input_vector~combout\(0)) # (\input_vector~combout\(1) $ (((\input_vector~combout\(2) & \input_vector~combout\(3)))))
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|ALT_INV_Y~0_combout\,
	oe => VCC,
