...
SIGNAL \add_instance|ALT_INV_Y[0]~0_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\add_instance|ALT_INV_Y[0]~0_combout\ <= NOT \add_instance|Y[0]~0_combout\;
...
-- Equation(s):
-- \add_instance|Y[0]~0_combout\ = ((\input_vector~combout\(1)) # ((\input_vector~combout\(2)) # (!\input_vector~combout\(0))))
...
-- Equation(s):
-- \add_instance|Y[1]~1_combout\ = ((\input_vector~combout\(1) & (\input_vector~combout\(0) & !\input_vector~combout\(2))))
...
-- Equation(s):
-- \add_instance|Y[2]~2_combout\ = ((!\input_vector~combout\(1) & (\input_vector~combout\(0) & \input_vector~combout\(2))))
...
-- Equation(s):
-- \add_instance|Y[3]~3_combout\ = ((\input_vector~combout\(1) & (\input_vector~combout\(0) & \input_vector~combout\(2))))
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|ALT_INV_Y[0]~0_combout\,
	oe => VCC,
